...
class FewShotDataset(Dataset):
    def __init__(self, dataset,
        ...
        self.image_conditioned_file = f'/home/aaditya23006/AMAN/SML/DATA/{task}/ImageSets/{dataset}/{image_conditioned_file}'
        self.image_conditioned_dir = f'/home/aaditya23006/AMAN/SML/DATA/{task}/JPEGImages/{dataset}/'
